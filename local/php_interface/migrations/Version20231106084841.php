...
class Version20231106084841 extends Version
{
	protected $description = "Создание инфоблока Исходящие документы";
	...
	{
		$helper = $this->getHelperManager();
		$helper->Iblock()->deleteIblockIfExists('outgoing-documents');
	}
}
